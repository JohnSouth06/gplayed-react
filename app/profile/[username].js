...
export default function PublicProfileScreen() {
  ...
  // Filtrer pour retirer strictement 'wishlist' et 'loaned' du comptage et de l'affichage
      ...
      <View style={styles.userInfoContainer}>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statBox}>
            ...
            <Text style={styles.statLabel}>{i18n.t('home.tab_physical') || 'Physique'}</Text>
          </View>
          <View style={styles.statDivider} />
          <View style={styles.statBox}>
            <Text style={styles.statValue}>{digitalCount}</Text>
            <Text style={styles.statLabel}>{i18n.t('home.tab_digital') || 'Digital'}</Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, color: '#fff', fontSize: 18, fontWeight: 'bold', textAlign: 'center', marginRight: 40 }, // Le margin compense l'icône de gauche pour centrer le texte
