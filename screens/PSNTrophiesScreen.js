...
export default function PSNTrophiesScreen() {
    ...
    return (
        <View style={styles.container}>
            {/* 1. On active le header natif avec Logo + Avatar */}
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyContainer}>
                            <Text style={styles.emptyText}>{i18n.t('psn.empty_text')}</Text>
                        </View>
                    }
                />
            )}
                ...
                <View style={styles.modalOverlayFull}>
                    <View style={styles.trophiesModalContent}>
                        <View style={styles.trophiesHeader}>
                            <Text style={[styles.modalTitle, { flex: 1, textAlign: 'left', marginBottom: 0 }]} numberOfLines={1}>{selectedGame?.title}</Text>
...
const styles = StyleSheet.create({
    ...
    pageHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
    syncButton: {  width: 44,  height: 44, borderRadius: 22, backgroundColor: '#4CE5AE', justifyContent: 'center', alignItems: 'center' },

    pageTitle: { fontSize: 28, fontWeight: 'bold', color: '#fff', marginBottom: 16 },
    listContainer: { paddingHorizontal: 16, paddingBottom: 40, flexGrow: 1 },
    emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 40, marginTop: 40 },
    emptyText: { color: '#6c7d76', textAlign: 'center', fontSize: 16 },
    ...
    modalTrophyImage: { width: 24, height: 32 },
