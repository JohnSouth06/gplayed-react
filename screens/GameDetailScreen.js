...
export default function GameDetailScreen() {
  ...
  const isIGDB = !!game.rating && !game.steam_appid; // Priorité Steam si les deux existent, ou simple présence de rating

  const [userRating, setUserRating] = useState(game?.user_rating ? game.user_rating.toString() : '');
