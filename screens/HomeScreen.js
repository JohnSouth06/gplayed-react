...
export default function HomeScreen() {
  ...
  const applyFiltersAndSort = () => {
    ...
    // On utilise notre nouvelle règle pour filtrer
    ...
    result.sort((a, b) => {
      ...
      // On utilise aussi la règle pour le tri alphabétique par plateforme
  ...
  // NOUVEAU : On génère la liste en appliquant la règle, on enlève les doublons, on trie, et on place "all" au début
