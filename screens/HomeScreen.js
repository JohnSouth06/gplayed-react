          ...
          <View style={styles.lendModalContent}>
            ...
            <TouchableOpacity style={[styles.lendInput, { justifyContent: 'center' }]} onPress={() => setShowDatePicker(true)}>
              <Text style={{ color: '#fff', fontSize: 16 }}>
                <MaterialIcons name="event" size={16} color="#6c7d76" /> {loanedDate.toLocaleDateString('fr-FR')}
              </Text>
            </TouchableOpacity>
              ...
              <View style={{ backgroundColor: '#202020', borderRadius: 12, padding: 10, marginBottom: 16 }}>
                <DateTimePicker
                  ...
                  onChange={(event, selectedDate) => {
                    // Sur Android, on ferme le picker immédiatement après le choix
                ...
                />
                {/* Sur iOS, le picker reste ouvert, il faut un bouton pour valider et fermer */}
                {Platform.OS === 'ios' && (
                  <TouchableOpacity
