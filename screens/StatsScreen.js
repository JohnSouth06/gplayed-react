    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.chartContainer}>
        ...
        <View style={styles.valueBarContainer}>
          {/* Barre visuelle Physique vs Digital */}
        ...
        <View style={styles.valueLabels}>
          <Text style={styles.valuePhysicalText}>• {i18n.t('stats.physical')} : {physicalValue.toFixed(2)} €</Text>
          <Text style={styles.valueDigitalText}>• {i18n.t('stats.digital')} : {digitalValue.toFixed(2)} €</Text>
        </View>
      </View>
